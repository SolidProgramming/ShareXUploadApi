...
## [Bookstack](https://bookstack.lucaweidmann.de/books/sharexuploadapi)
...
```
#### The table needed for authentication of users is created on the first request if the table doesn't exist(the default user is <i>admin:admin</i>).
```
